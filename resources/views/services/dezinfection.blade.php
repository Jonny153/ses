        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <p>Дезинфекция предприятий часто является необходимым условием деятельности организации.
                    ...
                    Мероприятия по обеззараживанию регламентируются рядом нормативных документов.
                ...
                <p><a href="/" class="black">Дезинфекция в Новороссийске, Геленджике, Анапе</a> от компании «СЭС-life» проводится с использованием
                ...
                <p>Мы стараемся решать задачу комплексно. В процессе обеззараживания наши специалисты стремятся
                    ...
                    дополнительные виды обработки, например, услуги <a href="/services/deratization" class="black">дератизации</a>
                    или <a href="/services/dezinsection" class="black">дезинсекции</a>.</p>
